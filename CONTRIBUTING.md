...
ThreadMesh is currently specification-and-conformance-first. The repository
also contains an experimental runtime, but contributions should turn observed
behavior into portable semantics and negative tests rather than expanding the
prototype without a protocol boundary.
...
3. Read the [current status](docs/10-planning/project-status.md) and
