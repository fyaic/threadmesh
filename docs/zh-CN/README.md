...
3. [人工转发与轮询基线](../06-guides/manual-relay-baseline.md)
4. [活跃 session 不打断案例](../06-guides/non-interrupting-handoff.md)
5. [Harness 支持与证据矩阵](../00-overview/harness-support.md)
6. [愿景](vision.md)
